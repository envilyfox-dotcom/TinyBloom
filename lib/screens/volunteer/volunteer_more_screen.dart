...
class VolunteerMoreScreen extends StatefulWidget {
  const VolunteerMoreScreen({super.key});

  @override
  State<VolunteerMoreScreen> createState() => _VolunteerMoreScreenState();
}

class _VolunteerMoreScreenState extends State<VolunteerMoreScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFFFFF5F7),
        elevation: 0,
        // ← goes to home (not pop) because More is a tab, not a pushed screen
        leading: IconButton(
