      ...
      body: _loading
          ...
          : RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  const Text(
                      'Track your daily symptoms, mood and baby milestones',
...
class _LogCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final date =
        log['logged_at'] != null ? DateTime.parse(log['logged_at']) : null;
    ...
    return TBCard(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          Expanded(
              child: _pillButton('View',
                  bg: _viewColor.withValues(alpha: 0.18),
                  fg: AppColors.roseDeep,
                  onTap: onView)),
          const SizedBox(width: 8),
          Expanded(
              child: _pillButton('Edit',
                  bg: _editColor, fg: Colors.white, onTap: onEdit)),
          const SizedBox(width: 8),
          Expanded(
              child: _pillButton('Delete',
                  bg: _deleteColor, fg: Colors.white, onTap: onDelete)),
        ]),
      ]),
    );
  }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Row(children: [
            Expanded(
                child: _pillButton('Edit', bg: _editColor, fg: Colors.white,
                    onTap: () async {
...
class _CreateLogScreenState extends State<CreateLogScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          AppBar(title: Text(isEdit ? 'Edit Log' : 'Symptoms & Milestones')),
      body: SingleChildScrollView(
